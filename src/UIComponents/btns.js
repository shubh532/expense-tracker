...
export function RedButton(props) {
    return (
        <button className={Style.RedButton} onClick={props.onClickHandler}>{props.children}</button>
    )
}

export function GreenButton(props) {
    return (
        <button className={Style.GreenButton} onClick={props.onClickHandler} >{props.children}</button>
    )
}

export function BlueButton(props) {
    return (
        <button className={Style.BlueButton} onClick={props.onClickHandler}>{props.children}</button>
    )
}
